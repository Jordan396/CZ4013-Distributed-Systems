...
{
	cout << "\u250f";  for (int i = 0; i < 77; i++) { cout << "\u2501"; }  cout << "\u2513" << endl;
	...
	cout << "\u2503" << "1. Freshness Interval (ms)  " << "\u2503" << freshnessInterval; for (int i = 0; i < 48 - to_string(freshnessInterval).length(); i++) {
		cout << " ";}  cout << "\u2503" << endl;
	cout << "\u2523";  for (int i = 0; i < 28; i++) { cout << "\u2501"; } cout << "\u254b";  for (int i = 0; i < 48; i++) { cout << "\u2501"; } cout << "\u252b" << endl;
	cout << "\u2503" << "2. Loss Rate (%)            " << "\u2503" << lossRate; for (int i = 0; i < 48 - to_string(lossRate).length(); i++) {
		cout << " ";}  cout << "\u2503" << endl;
	cout << "\u2523";  for (int i = 0; i < 28; i++) { cout << "\u2501"; } cout << "\u254b";  for (int i = 0; i < 48; i++) { cout << "\u2501"; } cout << "\u252b" << endl;
	cout << "\u2503" << "3. Time Out (ms)            " << "\u2503" << timeOut; for (int i = 0; i < 48 - to_string(timeOut).length(); i++) {
		cout << " ";}  cout << "\u2503" << endl;
	cout << "\u2523";  for (int i = 0; i < 28; i++) { cout << "\u2501"; } cout << "\u254b";  for (int i = 0; i < 48; i++) { cout << "\u2501"; } cout << "\u252b" << endl;
